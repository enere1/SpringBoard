	...
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				掲示文リスト
				<button id='regBtn' type="button" class="btn btn-xs pull-right">新しい文書く</button>
			</div>
			<!-- /.panel-heading -->
					...
					<div class="col-lg-12">
						...
						<form id='searchForm' action="/board/list" method='get'>
							<select name='type'>
								...
								<option value="TC"
									<c:out value="${pageMaker.cri.type eq 'TC'?'selected':''}"/>>Title
									or Content</option>
								<option value="TW"
									<c:out value="${pageMaker.cri.type eq 'TW'?'selected':''}"/>>Title
									or Writer</option>
								<option value="TWC"
									<c:out value="${pageMaker.cri.type eq 'TWC'?'selected':''}"/>>Title
